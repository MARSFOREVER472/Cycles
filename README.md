...
- **_Cabe destacar que existen 2 tipos de bucles, los que tienen un número de iteraciones no definidas, y los que tienen un número de iteraciones definidas. El ```while``` estaría dentro del primer tipo de variable. Más adelante veremos los ```for```, que se engloban en el segundo._**
